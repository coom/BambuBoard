...
static const BambuFilamentInfo bambu_filament_table[] = {
    ...
    // Support for PLA/PETG (S02-xxx)
    {"S02-W0", "65102", "Nature"},
    {"S02-W1", "65104", "White"},

    // Support for PA/PET (S03-xxx)
    {"S03-G1", "65500", "Green"},
