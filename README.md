...
|---|---|:---:|
| 🎨 [**Bambu Dashboard**](./bambu_dashboard/) | Dashboard complet : AMS, inventaire, KPIs, scan NFC | ![v1.0.20](https://img.shields.io/badge/v1.0.20-latest-success?style=flat-square) |
